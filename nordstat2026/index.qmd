...
<style>
@media print {
  .widget-container iframe { display: none; }
  .widget-container .print-fallback { display: block !important; }
}
</style>
...
<img src="figs/tvreg_screen.png" class="print-fallback" style="display:none; width:100%;"/>
</div>
:::
...
[Transformation to stability at every $t$]{.alertred} ![](figs/illustration_transformation.svg){width="100%" fig-align="center"}
...
- Nonlinear Gaussian models
  ...
  - [Posterior linearization filter]{.alertred} [@garcia2015posterior]
  
- Non-Gaussian models

  - [Posterior linearization filter - conditional moments version]{.alertred} [@tronarp2018iterative]
  ...
  - [Laplace filter]{.alertred} [@shephard1997likelihood; @koyama2010approximate]
    ...
    - [Automatic differentiation]{.alertred} makes it automatic.
...
::: footnote
Data from the FRED database at [https://fred.stlouisfed.org/](https://fred.stlouisfed.org/)
:::
...
- More [efficient sampling of dsp]{.alertred}. 

::: tinyskip
:::

- Better [prior elicitation for dsp]{.alertred}.
