...
$$
\v x_{i+1} = \v x_t - \gamma \red{\v I(\v x_t)^{-1}}\nabla f(\v x_t)
$$
...
- Prior at time $t=0$
$$
\v\theta_0 \sim N\Big(\v \mu_0, \frac{T}{\kappa_0}, \bar{I}^{-1}(\v\mu_0)\Big)
$$
where $\mu_0$ is backed out from beliefs about the data at time $t=0$. 
