...
- Use ideas from Information geometry. Natural gradient [@amari1998natural; @amari1982differential]
...
$$
- Fisher-scaled innovations controls the Kullback-Leibler divergence over time 
$$
...
- Prior at time $t=0$
$$
\v\beta_0 \sim N\Big(\v \mu_0, \frac{T}{\kappa_0}\mathcal{I}^{-1}(\v\mu_0)\Big)
$$
